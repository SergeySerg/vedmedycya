...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	...
	*/
    ...
    <body>
		<!--*|IF:MC_PREVIEW_TEXT|*-->
		<!--[if !gte mso 9]><!----><span class="mcnPreviewText" style="display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;">*Зворотній зв'язок*</span><!--<![endif]-->
		<!--*|END:IF|*-->
        <center>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; text-align: left;">
                            ...
                            <div style="text-align: center;">Форма зворотнього зв'язку<br>
&nbsp; &nbsp; &nbsp;</div>
<div style="text-align: center; width: 220px;margin: auto;">
<table class="tg">
	<tbody>
		<tr>
			<th class="tg-qnp3">Ім'я</th>
			<th class="tg-o45t">{{ $callback_name }}</th>
		</tr>
		<tr>
			<td class="tg-qnp3">Телефон</td>
			<td class="tg-ynlj">{{ $callback_phone }}</td>
		</tr>
	</tbody>
</table>
</div>
