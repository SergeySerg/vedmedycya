<table style="font-family:Arial, Helvetica, sans-serif;
    ...
    <tr>
        <td colspan="2" style="border-bottom: 1px solid #e0e0e0; font-style:italic; border-right: 1px solid #e0e0e0; background: #fafafa;  padding: 7px 17px; text-align: center;"><h4>Резюме додано вкладенням до листа</h4></td>
